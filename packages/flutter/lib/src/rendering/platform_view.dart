...
enum PlatformViewHitTestBehavior {
  ...
  /// Transparent targets don't receive events within their bounds.
  transparent,
}
  ...
  RenderAndroidView({
    ...
    @required this.hitTestBehavior,
       ...
       _viewController = viewController {
        _motionEventsDispatcher = new _MotionEventsDispatcher(this, viewController);
  }
...
class _MotionEventsDispatcher {
  _MotionEventsDispatcher(this.renderBox, this.viewController);
